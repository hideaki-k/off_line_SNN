...
print("spikes_in.segments[0].spiketrains.type",spikes_in.segments[0].spiketrains.shape)
...
print("spike_result.segment[0].spiketrains : ",spike_result.segments[0].spiketrains )
